...
function generateHTML(lieu, data) {
    ...
    html += '.hero{background:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)),url("/images/camion.png") center/cover no-repeat;padding:80px 0;position:relative;z-index:1}';
    ...
    html += '<div class="service-card"><img src="/images/rideaux-metalliques.jpg" alt="Rideau metallique" class="service-img"><div class="service-content"><h3>RIDEAU METALLIQUE</h3><p>Installation, reparation et depannage de rideaux metalliques.</p><span class="service-price">Des 150 EUR</span></div></div>';
    ...
    html += 'document.getElementById("expressForm").addEventListener("submit",function(e){e.preventDefault();var n=document.getElementById("exp_nom").value;var c=document.getElementById("exp_cp").value;var t=document.getElementById("exp_tel").value;var msg="<b>URGENCE EXPRESS</b>\\n\\n<b>Nom:</b> "+n+"\\n<b>CP:</b> "+c+"\\n<b>Tel:</b> "+t+"\\n<b>Page:</b> Serrurier "+LIEU;sendTelegram(msg);window.location.href="/merci";});';
    
    html += 'document.getElementById("contactForm").addEventListener("submit",function(e){e.preventDefault();var d={nom:document.getElementById("nom").value,telephone:document.getElementById("telephone").value,codepostal:document.getElementById("codepostal").value,adresse:document.getElementById("adresse").value,probleme:document.getElementById("probleme").value,urgence:document.getElementById("urgence").value};var msg="<b>DEMANDE DE DEVIS</b>\\n\\n<b>Nom:</b> "+d.nom+"\\n<b>Tel:</b> "+d.telephone+"\\n<b>CP:</b> "+d.codepostal+"\\n<b>Adresse:</b> "+d.adresse+"\\n<b>Probleme:</b> "+d.probleme+"\\n<b>Urgence:</b> "+d.urgence+"\\n<b>Page:</b> Serrurier "+LIEU;sendTelegram(msg);window.location.href="/merci";});';
