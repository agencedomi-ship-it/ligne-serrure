...
function generateSOSHTML(nom, titreComplet) {
    ...
    html += '.status-badge{display:inline-flex;align-items:center;gap:8px;background:rgba(34,197,94,0.1);border:1px solid var(--green);padding:10px 20px;border-radius:50px;margin-bottom:20px}';
