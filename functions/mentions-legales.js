export async function onRequest(context) {
    ...
    html += '<h2>Editeur du site</h2><p>Ligne-Serrure<br>Service de serrurerie d\'urgence</p>';
    html += '<h2>Hebergement</h2><p>Cloudflare Pages</p>';
    html += '<h2>Contact</h2><p>Telephone : 01 84 60 60 60</p>';
